...
const App: FC<AppProps> = ({ Component, pageProps }) => {
    ...
    return (
        <>
            ...
            <meta name="description" content="Candibar NFTs - Buy, Trade, and Sell Unique Digital Assets. Candibar Tokens Marketplace." />
            <meta name="keywords" content="Candibar, NFTs, Buy, Trade, Sell, Tokens, Digital Assets, Collectibles, Digital Art" />
            <meta name="author" content="Candibar" />
            <meta property="og:title" content="Candibar NFTs" />
            <meta property="og:description" content="Candibar NFTs - Buy, Trade, and Sell Unique Digital Assets | Candibar Tokens Marketplace" />
            ...
            <meta name="twitter:description" content="Candibar NFTs - Buy, Trade, and Sell Unique Digital Assets | Candibar Tokens Marketplace" />
