...
export const HomeView: FC = ({ }) => {
  ...
  return (
    <>
      ...
      {/* start content 1 */}
      <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 50 }} transition={{ duration: .7 }} className="text-center mt-8 p-[3%] mb-8">
      ...
      {/* start content 2 */}
      <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 50 }} transition={{ duration: 0.7 }} className="text-center mt-4 p-[6%]">
        <div className="max-w-7xl mx-auto bg-gray-900 shadow-lg rounded-lg overflow-hidden mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 50 }} transition={{ duration: 0.7 }} className="text-center mt-4 p-2">
      ...
      {/* start content 3 */}
      <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 50 }} transition={{ duration: 0.7 }} className="max-w-lg mx-auto bg-gray-900 shadow-lg rounded-lg overflow-hidden mb-8 mt-8">
        <motion.div whileHover={{ scale: 1.05 }}>
          <div className="bg-gradient-to-br from-pink-400 to-blue-400 p-4">
            <h1 className="text-center text-2xl md:pl-6 font-bold text-black">
        ...
        <div className="p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
            ...
            {items.slice(0, 1).map((item) => (
              <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 50 }} transition={{ duration: 0.7 }} key={item.id} className="flex flex-col items-center relative">
