        ...
        {images.map((pic, index) => (
          ...
          >
            ...
            <div key={index} className="w-full mb-4">
                <div className={`flex space-x-4 ${selectedImage === pic.src ? 'border-4 border-white rounded-xl' : ''}`}>
                <div className="relative">
                  ...
                  width={100}
                  height={100}
                  className="flex flex-wrap cursor-pointer hover:opacity-75 rounded-xl shadow-lg"
