...
const candyMachineAddress = publicKey(process.env.NEXT_PUBLIC_CANDY_MACHINE_ID03);
const collectionMint = publicKey(process.env.NEXT_PUBLIC_COLLECTION_ID03);
import Confetti from "react-confetti";
import useWindowSize from 'react-use/lib/useWindowSize';

export const MintSnake03: FC = () => {
