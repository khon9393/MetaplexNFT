...
const candyMachineAddress = publicKey(process.env.NEXT_PUBLIC_CANDY_MACHINE_ID02);
const collectionMint = publicKey(process.env.NEXT_PUBLIC_COLLECTION_ID02);
import Confetti from "react-confetti";
import useWindowSize from 'react-use/lib/useWindowSize';

export const MintSnake02: FC = () => {
